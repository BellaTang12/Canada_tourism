...
clean_data %>% ggplot(aes(x=total_spending))+geom_histogram(fill="blue",color="white",bins =80 )+theme_classic()+labs(x="Total spending in Canada",y="Frequency", title="Histogram showing distribution of traveler's total spending in Canada")
...
\newpage
```{r fig6,echo=FALSE,message=FALSE,warning=FALSE, fig.cap = "A scatterplot"}
# scatterplot of total days
clean_data%>%ggplot(aes(x=as.numeric(total_days),y=total_spending,colour=trip_reason))+
  labs(x="Total days in Canada",y="Total spending", title = "Scatterplot between total days and total spending in Canada")+
  geom_point(alpha=0.5)+
  theme_classic()+
  theme(legend.position = "bottom")+
  guides(color=guide_legend("Trip reason"))+
  scale_color_discrete(breaks=c("1","2","3","4","5","6"),labels=c("Holidays, leisure or recreation","To visit friends or relatives","Other personal - pleasure", "Personal reason - other", "Attend a conference, convention or trade show", "Other business reason"))
```
...
```{r fig7,echo=FALSE,message=FALSE,warning=FALSE, fig.cap = "A scatterplot"}
# linear regression on total spending and total days
clean_data%>%ggplot(aes(x=as.numeric(total_days),y=total_spending,colour=trip_reason))+
  labs(x="Total days in Canada",y="Total spending", title = "Linear relationship between total days and total spending in Canada")+
  geom_point(alpha=0.5)+
