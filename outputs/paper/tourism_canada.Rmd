...
The dataset used in this paper is provided by International Travel Survey (ITS) conducted by Statistics Canada. The survey was conducted from January 1st to	December 31st 2017. The target population of the dataset includes all travelers on entry or re-entry into Canada geographically covering all provinces and territories, census metropolitan area (CMA). The dataset is released on July 21st 2020. There's 12866 observations in the dataset after data cleaning.\
